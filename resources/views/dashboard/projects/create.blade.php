...
@section('title-header', 'Tambah Data Tugas Akhir')
@section('breadcrumb')
    <div class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></div>
    <div class="breadcrumb-item"><a href="{{ route('projects.index') }}">Data Tugas Akhir</a></div>
    <div class="breadcrumb-item active">Tambah Data Tugas Akhir</div>
@endsection
        ...
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h4>Formulir Tambah Data Tugas Akhir</h4>
                </div>
                <div class="card-body">
                                    ...
                                    <select class="form-control @error('dosen_id') is-invalid @enderror" id="dosen_id"
                                        ...
                                        @foreach ($lecturers as $dosen)
                                            <option value="{{ $dosen->id }}"
                                                @if (old('dosen_id') == $dosen->id) selected @endif>
                                                {{ $dosen->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control @error('topik_id') is-invalid @enderror" id="topik_id"
                                        ...
                                        @foreach ($topics as $topic)
                                            <option value="{{ $topic->id }}"
                                                @if (old('topik_id') == $topic->id) selected @endif>
                                                {{ $topic->judul }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control @error('bimbingan_id') is-invalid @enderror" id="bimbingan_id"
                                        ...
                                        @foreach ($guidances as $guidance)
                                            <option value="{{ $guidance->id }}"
                                                @if (old('bimbingan_id') == $guidance->id) selected @endif>
                                                {{ $guidance->dosen->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="form-control @error('kelengkapan_id') is-invalid @enderror" id="kelengkapan_id"
                                        ...
                                        @foreach ($completeness as $completen)
                                            <option value="{{ $completen->id }}"
                                                @if (old('kelengkapan_id') == $completen->id) selected @endif>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('skta_id') is-invalid @enderror" id="skta_id"
                                        ...
                                        @foreach ($skta as $sk)
                                            <option value="{{ $sk->id }}"
                                                @if (old('skta_id') == $sk->id) selected @endif>
                                                {{ $sk->surat }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-control @error('tat_id') is-invalid @enderror" id="tat_id"
                                        ...
                                        @foreach ($tat as $ta)
                                            <option value="{{ $ta->id }}"
                                                @if (old('tat') == $ta->id) selected @endif>
                                                {{ $ta->tugas_akhir }}
                                            </option>
                                        @endforeach
                                    </select>
